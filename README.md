...
## 1. [Volatility Forecasting on Equity Returns: GARCH-Family Models vs. Gradient Boosting](portfolio/Volatility_Forecasting_GARCH_vs_GradientBoosting.ipynb)
...
## 2. [Momentum Strategy Backtest on S&P 500 (CRSP Data)](portfolio/Momentum_Backtest_SP500.ipynb)
...
## 3. [Comparative Evaluation of VaR Models: Parametric vs. Hybrid Approach](portfolio/VaR_Models_Comparison) (Group Project)
